...
func TestVerifyX509CertChainGoodChain(t *testing.T) {
	...
	assert.NoError(t, VerifyEKCertChain(allCerts, nil))
	assert.NoError(t, VerifyEKCertChain([]*x509.Certificate{ekCertx509}, GetCertPool(append([]x509.Certificate{}, *rootCertx509, *intermediate1Certx509))))
}
...
func TestVerifyX509CertChainExpired(t *testing.T) {
	...
	assert.Error(t, VerifyEKCertChain(allCerts, nil))
	assert.Error(t, VerifyEKCertChain([]*x509.Certificate{ekCertx509}, GetCertPool(append([]x509.Certificate{}, *rootCertx509, *intermediate1Certx509))))
